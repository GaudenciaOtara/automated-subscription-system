...
<link href="../Kalani/css/style.css" rel="stylesheet" type="text/css" media="all"/>
						...
						<div class="price-grid">
							<div class="price-block agile">
								...
								<div class="price-selet pric-sclr1">
									<a class="popup-with-zoom-anim" data-plan="basic" data-price="5.00" href="payment.php">Pay</a>
								</div>
							</div>
						</div>
						<div class="price-grid">
							<div class="price-block agile">
								...
								<div class="price-selet pric-sclr2">
									<a class="popup-with-zoom-anim" data-plan="standart" data-price="10.00" href="payment.php">Pay</a>
								</div>
							</div>
						</div>
						<div class="price-grid wthree">
							<div class="price-block agile">
								...
								<div class="price-selet pric-sclr3">
									<a class="popup-with-zoom-anim" data-plan="premium" data-price="20.00" href="payment.php">Pay</a>
								</div>
							</div>
						</div>
						<div class="clear"> </div>
